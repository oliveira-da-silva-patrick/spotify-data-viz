...
hist2023 |>
  ...
  labs(title = "When did I use Spotify?",
       y = element_blank(),
       x = element_blank()) +
...
### Does Spotify define genres with the song's audio features? {style="center: true"}

Let's look at the audio features of the albums of different artists/bands.
